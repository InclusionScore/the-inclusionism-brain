...
export const metadata: Metadata = {
  ...
  description: "Compare Inclusionism with political, economic, and future-oriented frameworks across value, agency, legitimacy, ownership, and belonging.",
  ...
  return (
    <main className="brain-grid mx-auto max-w-7xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-6 max-w-4xl border-l-4 border-signal pl-5 text-lg leading-8 text-white/70">
        ...
        Inclusionism should be tested against other frameworks by asking whether it better explains value, agency, legitimacy, fairness, belonging, ownership,
        AI, democracy, race, class, and civilization.
      </p>
